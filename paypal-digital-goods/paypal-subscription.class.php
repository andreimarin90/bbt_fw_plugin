...
class PayPal_Subscription extends PayPal_Digital_Goods{
        ...
        public function cancel_subscription($profile_id){
            return $this->call_paypal( 'ManageRecurringPaymentsProfileStatus', $profile_id, 'Cancel', array('note' => esc_html__('Profile cancelled at store', 'materialist')) );
        }
         ...
         */
        public function change_subscription_status( $profile_id = '', $action = 'Cancel' ) {
            $api_request = parent::get_payment_details_url( $action, $profile_id );
            bbt_print_r($api_request);
